...
int bytes;
{
	...
	*(c + 0)=port;
	*(c + 1)=bytes;
		asm	"db 0x1E,0x06,0x50,0x53,0x51,0x52,0x56,0x57,0x2E,0x8B,0x16,0x80,0x00,0x2E,0xA0,0x82,0x00,0xEE,0x5F,0x5E,0x5A,0x59,0x5B,0x58,0x07,0x1F";
